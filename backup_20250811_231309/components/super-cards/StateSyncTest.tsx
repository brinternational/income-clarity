...
export function StateSyncTest({ className = '' }: StateSyncTestProps) {
  ...
  const runSyncTest = async () => {
    ...
    // console.log('🧪 Starting State Synchronization Tests...')

    // Test 1: Performance data update
    // console.log('Test 1: Performance data update')
    ...
    // console.log('Test 2: Income data update')
    ...
    // console.log('Test 3: Optimistic update test')
    // const optimisticStart = performance.now()
    
    // Apply optimistic update
    optimisticUpdate((state) => {
      state.performanceHub.portfolioValue = 999999
    })
    ...
    // console.log('Test 4: Cross-card state sharing')
    ...
    // console.log('Test 5: Selective subscription efficiency')
