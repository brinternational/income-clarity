    ...
    <div className={`space-y-6 ${className}`}>
      ...
      <div className="text-center">
        <div className="flex items-center justify-center mb-2">
          ...
          <h3 className="text-lg font-semibold text-slate-800">Tax Intelligence Engine</h3>
        </div>
        <p className="text-sm text-slate-600">Smart analysis of your current tax burden and optimization opportunities</p>
      </div>
        ...
        {recommendations.map((rec, index) => (
          <div key={index} className="bg-white rounded-lg p-4 border border-slate-200 hover:border-primary-300 transition-colors">
            <div className="flex items-center justify-between mb-2">
              <h5 className="font-semibold text-slate-800">{rec.action}</h5>
            ...
            <div className="flex items-center justify-between">
              <span className="text-sm text-slate-600">Potential annual savings</span>
      ...
      <div className="bg-white rounded-lg p-4 border border-slate-200">
        <div className="flex items-center justify-between mb-3">
          <h4 className="font-semibold text-slate-800">Tax Efficiency Score</h4>
