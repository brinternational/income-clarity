        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            ...
            <div className="hidden md:flex items-center space-x-4">
              ...
              {/* Premium users - Bank Connections */}
              {isPremium && (
                <button
                  onClick={handleNavigateToBankConnections}
                  className="flex items-center space-x-2 px-3 py-2 text-purple-600 hover:text-purple-700 dark:text-purple-400 dark:hover:text-purple-300 transition-colors rounded-lg hover:bg-purple-50 dark:hover:bg-purple-900/20"
                >
                  <Crown className="h-4 w-4" />
                  <span>Bank Sync</span>
                  <span className="px-2 py-0.5 text-xs bg-purple-100 text-purple-700 dark:bg-purple-900/30 dark:text-purple-300 rounded-full">
                    Premium
                  </span>
                </button>
              )}
              ...
              {isFreeTier && (
                <button
                  ...
                  className="flex items-center space-x-2 px-3 py-2 text-blue-600 hover:text-blue-700 dark:text-blue-400 dark:hover:text-blue-300 transition-colors rounded-lg hover:bg-blue-50 dark:hover:bg-blue-900/20"
                >
                  <Crown className="h-4 w-4" />
                  <span>Upgrade</span>
                  <span className="px-2 py-0.5 text-xs bg-gradient-to-r from-blue-100 to-purple-100 text-blue-700 dark:bg-gradient-to-r dark:from-blue-900/30 dark:to-purple-900/30 dark:text-blue-300 rounded-full">
                    Premium
                  </span>
                </button>
              )}
                      ...
                      <div className="py-1">
                        ...
                        {isPremium ? (
                          <>
                            <button
                              onClick={handleNavigateToBankConnections}
                              className="w-full px-4 py-2 text-left text-sm text-purple-700 hover:text-purple-900 dark:text-purple-300 dark:hover:text-purple-100 hover:bg-purple-50 dark:hover:bg-purple-900/20 flex items-center space-x-2"
                            >
                              <Crown className="h-4 w-4" />
                              <span>Bank Connections</span>
                              <span className="ml-auto px-1.5 py-0.5 text-xs bg-purple-100 text-purple-700 dark:bg-purple-900/30 dark:text-purple-300 rounded">
                                Premium
                              </span>
                            </button>
                            <button
                          ...
                          >
                            ...
                            <span className="ml-auto px-1.5 py-0.5 text-xs bg-gradient-to-r from-blue-100 to-purple-100 text-blue-700 dark:bg-gradient-to-r dark:from-blue-900/30 dark:to-purple-900/30 dark:text-blue-300 rounded">
                              Free Trial
                            </span>
                          </button>
                        )}
