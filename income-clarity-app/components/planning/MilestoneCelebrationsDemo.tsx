      ...
      <div className="bg-white rounded-2xl border border-slate-200 p-6">
        <div className="flex items-center justify-between mb-6">
          <div className="flex items-center space-x-3">
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground">Test milestone celebrations</p>
            </div>
          </div>
          
          <button
            onClick={resetProgress}
            className="flex items-center space-x-2 px-4 py-2 bg-slate-100 text-foreground/90 rounded-lg hover:bg-slate-200 transition-colors"
          >
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mt-6 pt-6 border-t border-slate-200">
          <label className="flex items-center space-x-2">
            ...
            />
            <span className="text-sm text-foreground/90">Haptics</span>
          </label>
          ...
          <label className="flex items-center space-x-2">
            <input
              ...
              className="rounded border-slate-300 text-primary-600 focus:border-primary-300 focus:ring focus:ring-primary-200 focus:ring-opacity-50"
            />
            <span className="text-sm text-foreground/90">Sounds</span>
          </label>
          ...
          <label className="flex items-center space-x-2">
            <input
              ...
              className="rounded border-slate-300 text-primary-600 focus:border-primary-300 focus:ring focus:ring-primary-200 focus:ring-opacity-50"
            />
            <span className="text-sm text-foreground/90">Auto Detect</span>
          </label>
          ...
          <label className="flex items-center space-x-2">
            <input
              ...
              className="rounded border-slate-300 text-primary-600 focus:border-primary-300 focus:ring focus:ring-primary-200 focus:ring-opacity-50"
            />
            <span className="text-sm text-foreground/90">Persist</span>
          </label>
        </div>
      </div>
