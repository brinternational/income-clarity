...
export class ConnectivityErrorBoundary extends Component<Props, State> {
  ...
  componentDidCatch(error: Error, errorInfo: any) {
    ...
    // logger.error('ConnectivityErrorBoundary caught an error:', error, errorInfo)
    ...
    if (isConnectivityError) {
      // logger.warn('🌐 Connectivity error detected, showing user-friendly fallback')
    }
  }
...
export function useConnectivityErrorHandler() {
  const handleError = (error: Error) => {
    ...
    if (isConnectivityError) {
      // logger.warn('🌐 Connectivity error in functional component:', error)
