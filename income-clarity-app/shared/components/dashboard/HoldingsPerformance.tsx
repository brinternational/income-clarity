...
import { SkeletonHoldingsPerformance } from '@/shared/components/ui/skeletons'
...
export function HoldingsPerformance({ onAddHolding }: HoldingsPerformanceProps) {
  ...
  const handleHoldingHover = useCallback((tickerId: string | null) => {
    setHoveredHolding(tickerId)
  }, [])
  ...
  // Memoized sorting and filtering logic with proper null safety
  ...
  }, [safeHoldings, filterBy, sortBy, spyReturn])
        ...
        {displayedHoldings.length === 0 ? (
          ...
          return (
            <div 
              ...
              onMouseEnter={() => handleHoldingHover(holding.id)}
